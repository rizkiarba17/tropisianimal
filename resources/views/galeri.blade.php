...
@section('container')
    <div id="galeri" class="container">
       ...
       <a class="btn {{ ($title === "kontak" ? 'active' : '') }}" href="/kontak" style="background-color: green; padding: 10px; color: white;">baca selengkapnya <img src="aset/panah.svg" alt="arah-tombol"></a>
        <h1>
            <h1>
    </div>
@endsection
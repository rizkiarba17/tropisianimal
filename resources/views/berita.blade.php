        ...
        <div id="bagian-content-berita">
            <div class="row">
                ...
                <div class="col-6 align-content-center" style="padding: 25px;">
                    ...
                    <a class="btn {{ ($title === "galeri" ? 'active' : '') }}" href="/galeri" style="background-color: green; padding: 10px; color: white;">baca selengkapnya <img src="aset/panah.svg" alt="arah-tombol"></a>
                </div>
            </div>
        </div>

    ...
    <div id="bagian-tentang-home" class="container">
        <div class="row" style="margin-top:50px;">
            <div class="col-6 isi">
                ...
                <a class="btn {{ ($title === "Tentang" ? 'active' : '') }}" href="/tentang" style="background-color: green; padding: 10px; color: white;">baca selengkapnya <img src="aset/panah.svg" alt="arah-tombol"></a>
            </div>
